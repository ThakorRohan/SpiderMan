...
from spiderman import dispatcher, updater, TOKEN, WEBHOOK, OWNER_ID, CERT_PATH, PORT, URL, LOGGER, \
     BLACKLIST_CHATS, WHITELIST_CHATS
# needed to dynamically load modules
# NOTE: Module order is not guaranteed, specify that in the config file!
from spiderman.modules import ALL_MODULES
from spiderman.modules.helper_funcs.chat_status import is_user_admin
from spiderman.modules.helper_funcs.misc import paginate_modules
...
Join My [Support Group](http://t.me/spiderbotsupport) if you need any support or help

 Or 

If You Want To Know New Updates About [Me](https://t.me/spiderman_ProBot) Then Join My [Updates Channel](spiderman_Updates).
...
buttons = [[
InlineKeyboardButton(text="➕ Add to Group ➕", url="t.me/spiderman_ProBot?startgroup=true"),
InlineKeyboardButton(text="🔔 Updates 🔔", url="https://t.me/spiderman_Updates")
                  ]]
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("spiderman.modules." + module_name)
