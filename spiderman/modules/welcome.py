...
import spiderman.modules.sql.welcome_sql as sql
from spiderman.modules.sql.global_bans_sql import is_user_gbanned
from spiderman import dispatcher, OWNER_ID, LOGGER, MESSAGE_DUMP
from spiderman.modules.helper_funcs.chat_status import user_admin, is_user_ban_protected
from spiderman.modules.helper_funcs.misc import build_keyboard, revert_buttons
from spiderman.modules.helper_funcs.msg_types import get_welcome_type
...
from spiderman.modules.log_channel import loggable
    ...
    if should_welc:
        ...
        for new_mem in new_members:
            ...
            # Make bot greet admins
                ...
                " and be sure to join our channel:- @spiderman_Updates to know more about updates and tricks!".format(user.first_name, context.bot.first_name, chat_name), reply_to_message_id=reply)

                context.bot.send_message(
                    MESSAGE_DUMP,
                    "@SpiderMan_ProBot has been added to {} with ID: <pre>{}</pre>".format(
                        chat.title, chat.id),
